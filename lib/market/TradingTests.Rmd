...
CreateMarket(Title="Hillary",
             B=3.5,
             D.State=list(c("Did Hillary R Clinton win the United States 2016 presidential election?"),
...
plot(TradeCost~MarketPrice , data=SFE,main="The 'Self-Financing Effect'",sub="Cost to trade s.t. MarketPrice increases by 0.01551724.",xlim=c(.55,1))
